# Generated by Django 2.2.12 on 2023-11-29 12:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now=True)),
                ('subject_name', models.CharField(default='RDBMS', max_length=250)),
                ('subject_code', models.CharField(default='CSE 4508', max_length=50)),
                ('assignments', models.ManyToManyField(blank=True, related_name='classrooms', to='classroom.ClassAssignment')),
                ('materials', models.ManyToManyField(blank=True, related_name='classrooms', to='classroom.ClassMaterial')),
                ('meet_links', models.ManyToManyField(blank=True, related_name='classrooms', to='classroom.MeetLink')),
                ('notices', models.ManyToManyField(blank=True, related_name='classrooms', to='classroom.ClassNotice')),
                ('students', models.ManyToManyField(blank=True, related_name='classrooms', to='classroom.Student')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_classrooms', models.ManyToManyField(blank=True, related_name='teachers_created', to='classroom.Classroom')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marks_added', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='marks', to='classroom.ClassAssignment')),
        ...
        migrations.AddField(
            model_name='meetlink',
            name='students',
            field=models.ManyToManyField(related_name='class_meet', to='classroom.Student'),
        ),
        migrations.AddField(
            model_name='meetlink',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_meet', to='classroom.Teacher'),
        ),
        migrations.AddField(
            model_name='classroom',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='classrooms', to='classroom.Teacher'),
        ),
        migrations.AddField(
            model_name='classnotice',
            name='students',
            field=models.ManyToManyField(related_name='class_notice', to='classroom.Student'),
        ),
        migrations.AddField(
            model_name='classnotice',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher', to='classroom.Teacher'),
        ),
        migrations.AddField(
            model_name='classmaterial',
            name='student',
            field=models.ManyToManyField(related_name='student_material', to='classroom.Student'),
        ),
        migrations.AddField(
            model_name='classmaterial',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_material', to='classroom.Teacher'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roll_no', models.ForeignKey(db_column='roll_no', on_delete=django.db.models.deletion.CASCADE, to='classroom.Student', to_field='roll_no')),
            ],
        ),
